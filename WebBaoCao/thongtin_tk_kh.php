...
$tency = "";
$email = "";
if (isset($_POST['tenkh']) && isset($_POST['tency']) && isset($_POST['email'])) {
    $ten = $_POST['tenkh'];
    $tency = $_POST['tency'];
    $email = $_POST['email'];
    if ($ten != "" && $tency != "" && $email != "") {
        ...
        $sql = "update KhachHang set HoTenKH='" . $ten . "',TenCongTy='" . $tency . "',Email='" . $email . "' 
    where MSKH=" . $kh . ";";
...
<head>
    <title>Tài khoản - Thông tin</title>
    <meta charset="utf-8">
...
<body>
    ...
    <section id="taikhoan-section">
        <div id="bar" name="bar" class=bar>
            ...
            <ul class="bar-ul">
                <li class="bar-li">
                    <a href="taikhoan_kh.php" class="li-tide"><i class="fas fa-file-invoice-dollar"></i><b>Đơn mua</b></a>
                </li>
                <li class="bar-li">
                    <a class="li-tide" style="color: var(--color-1);"><i class="fas fa-id-badge"></i><b>Tài khoản</b></a>
                </li>
                <li class="bar-li">
        ...
        <div id="work" class="work" style="background-color: rgba(205, 225, 243, 0);">
            <form class="form" action="" method="POST">
                ...
                echo '
                    ...
                    <span>Họ và tên: </span><input name="tenkh" type="text" value="' . $row['HoTenKH'] . '"><br>
                    <span>Tên công ty: </span><input name="tency" type="text" value="' . $row['TenCongTy'] . '"><br>
                    <span>Email: </span><input name="email" value="' . $row['Email'] . '" type="text"><br>
                    <button class="from-btn" type="submit">Lưu thay đổi</button>
                    <a href="" class="form-a-btn">Hủy bỏ</a>
                    </form>';

                echo '<form class="form" action="" method="POST" id="form_diachi">
                <h2>ĐỊA CHỈ</h2>
                <span>Địa chỉ giao hàng(*) </span><input name="diachi" type="text" value="' . diachikhachhang($kh, $connect) . '"><br>
