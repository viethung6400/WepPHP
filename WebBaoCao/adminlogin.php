...
function sign_in()
{
    ...
    if (!empty($_POST)) {
        ...
        $query = "SELECT * FROM NhanVien Where SoDienThoai='" . $tk . "' AND Password=MD5('" . $mk . "');";
...
<body>
    ...
    <section id="login">
        <div>
            <H1 style="color: white; height: 70px; line-height: 70px;">Đăng nhập vào trang quản lý! Tài khoản quản trị.</H1>
            <form id="loginfrom" method="POST" action="">
                ...
                <div class="btnDiv" style="text-align: center; width: 100%;">
